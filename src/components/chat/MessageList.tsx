  ...
  if (messages.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-full px-4 text-center">
        <div className="flex items-center justify-center w-14 h-14 rounded-2xl bg-violet-50 mb-4 shadow-sm">
      ...
      <div className="space-y-6 max-w-4xl mx-auto w-full">
        {messages.map((message) => (
          ...
          >
            ...
            {message.role === "user" && (
              <div className="flex-shrink-0">
                <div className="w-9 h-9 rounded-lg bg-violet-600 shadow-sm flex items-center justify-center">
